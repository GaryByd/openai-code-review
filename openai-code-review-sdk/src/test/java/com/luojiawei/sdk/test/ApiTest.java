...
//import com.luojiawei.sdk.infrastructure.weixin.dto.MessageDTO;
...
//
//        ChatCompletionSyncResponseDTO chatCompletionSyncResponseDTO = JSON.parseObject(content.toString(), ChatCompletionSyncResponseDTO.class);
//        System.out.println(chatCompletionSyncResponseDTO.getChoices().get(0).getMessage().getContent());
//    }
//
//    @Test
//    public void test_wx(){
...
//        messageDTO.put("project","big-market");
//        messageDTO.put("review","feat: 新加功能");
//        String url = String.format("https://api.weixin.qq.com/cgi-bin/message/template/send?access_token=%s", accessToken);
//        sendPostRequest(url,JSON.toJSONString(messageDTO));
//    }
//
